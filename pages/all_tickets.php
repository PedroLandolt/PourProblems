...
// Can't access this page if not logged in
if (!$session->isLoggedIn()) {
  header('Location: ../pages/login.php');
}

// Check if user is not an agent or not an admin
...
<div class="heading" style="background: url('../sources/heading_bg/tickets.jpg');">
  <h1>All Tickets</h1>
</div>
